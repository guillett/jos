...
RSpec.describe Code, type: :model do
  ...
  describe "summary" do
    ...
    describe "with a code with 1 section with 2 articles" do
      before do
        code = Code.new()
        s1 = Section.new(title: '1')
        a1 = Article.new()
        sal = SectionArticleLink.new(section: s1, article: a1)
      ...
      it "preload all the section link" do
        expect(@summary[0].section_article_links_preloaded.length).to eq(1)
      end
